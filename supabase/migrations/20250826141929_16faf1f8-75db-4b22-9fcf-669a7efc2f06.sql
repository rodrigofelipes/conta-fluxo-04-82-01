-- Temporariamente desabilitar o trigger que está causando conflito
ALTER TABLE profiles DISABLE TRIGGER auto_create_user_role_trigger;
...
ALTER TABLE profiles ENABLE TRIGGER auto_create_user_role_trigger;
