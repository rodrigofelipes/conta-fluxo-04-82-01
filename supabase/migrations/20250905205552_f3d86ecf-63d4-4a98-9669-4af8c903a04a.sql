-- Step 1: Create employee_profiles table for internal collaborators (user_type enum already exists)
...
-- Step 2: Create client_profiles table for clients with system access
...
-- Step 3: Add has_system_access to clientes table if it doesn't exist
ALTER TABLE public.clientes ADD COLUMN IF NOT EXISTS has_system_access BOOLEAN DEFAULT false;

-- Step 4: Enable RLS on new tables
ALTER TABLE public.employee_profiles ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.client_profiles ENABLE ROW LEVEL SECURITY;

-- Step 5: Create RLS policies for employee_profiles
...
-- Step 6: Create RLS policies for client_profiles
...
-- Step 7: Migrate existing data from profiles to employee_profiles
...
-- Step 8: Create client profiles for users that match existing clients
...
-- Step 9: Update has_system_access for clients with profiles
...
-- Step 10: Update user_type in user_roles based on new profile tables
...
-- Step 12: Create function to get user profile type
